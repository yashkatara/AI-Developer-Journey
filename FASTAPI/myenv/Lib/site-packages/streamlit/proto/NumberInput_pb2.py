...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_NUMBERINPUT']._serialized_end=600
  _globals['_NUMBERINPUT_DATATYPE']._serialized_start=492
  _globals['_NUMBERINPUT_DATATYPE']._serialized_end=522
